                                ...
                                let filters = filters.iter().map(|x| match &x {
                                    ...
                                    AccountFilterType::Memcmp(memcmp) => {
                                        match memcmp.data {
                                            ...
                                            crate::account_filter::MemcmpFilterData::Base58(_) |
                                            crate::account_filter::MemcmpFilterData::Base64(_) => {
                                                AccountFilterType::Memcmp(MemcmpFilter {
                                                    offset: memcmp.offset,
                                                    data: crate::account_filter::MemcmpFilterData::Bytes(memcmp.bytes())
                                                })
                                            },
                                        }
                                    },
...
#[cfg(test)]
mod tests {
    use crate::account_filter::{AccountFilter, AccountFilterType, MemcmpFilter};
    use solana_sdk::pubkey::Pubkey;
    ...
    fn test_program_that_partial_filtering() {
        ...
        assert!(simple_store.contains_filter_internal(&AccountFilter {
            ...
            filters: Some(vec![
                AccountFilterType::Memcmp(MemcmpFilter {
                    offset: 5,
                    data: crate::account_filter::MemcmpFilterData::Bytes(vec![8, 9, 10])
                }),
                AccountFilterType::Memcmp(MemcmpFilter {
                    offset: 2,
                    data: crate::account_filter::MemcmpFilterData::Bytes(vec![123])
