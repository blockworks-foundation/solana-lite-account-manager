...
impl MemcmpFilter {
    ...
    pub fn bytes(&self) -> Vec<u8> {
        match &self.data {
            ...
            MemcmpFilterData::Base58(b58) => bs58::decode(b58)
                .into_vec()
                .expect("Base58 decoding should work"),
            MemcmpFilterData::Base64(b64) => base64::engine::general_purpose::STANDARD
                .decode(b64)
                .expect("B64 decoding should work"),
        }
    }
